    ...
    public void spustiSimulaciu() {
        ...
        _simulaciaDopravy.setKonfiguracia((
                new KonfiguraciaVozidiel(PREVADZKA_LINIEK.PO_NASTUPENI_ODCHADZA, new ArrayList<>(Arrays.asList(
                        ...
                        new VozidloKonfiguracia(TYP_VOZIDLA.AUTOBUS_TYP_1, TYP_LINKY.LINKA_A, 90.0),
                        new VozidloKonfiguracia(TYP_VOZIDLA.AUTOBUS_TYP_1, TYP_LINKY.LINKA_B, 90.0)
                )))
        ));
        _simulaciaDopravy.simulate(100, Helper.CASOVE_JEDNOTKY.DEN.getPocetSekund() * 10);
    }
}
